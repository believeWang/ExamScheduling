...
<div><fieldset>
				...
				<c:forEach var="EmployeeVO" items="${list}" begin="<%=pageIndex%>"
					...
					<tr align='center' valign='middle'>
						<FORM METHOD="post"
							...
							<td><input type="submit" value="刪除"> <input
								type="hidden" name="empno" value="${EmployeeVO.empno}">
								<input type="hidden" name="action" value="delete1"></td>
						</FORM>
						...
						<td>
							<FORM METHOD="post"
								...
								<input type="submit" value="修改"> <input type="hidden"
									name="empno" value="${EmployeeVO.empno}"> <input
		...
		<a href='<%=request.getContextPath()%>/employee/Emptable.jsp'>員工</a>
