...
public class ExamService {
	...
	// 初始化
		public void initExam(HttpSession session, HttpServletRequest request,ServletContext context) {
		...
		public void questionToJSON(HttpSession session,
				HttpServletResponse response, int targetQuestion,ServletContext context)
				throws IOException {
			//取得考試編號
			 String examno=(String)session.getAttribute("examno");
